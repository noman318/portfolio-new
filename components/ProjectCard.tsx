...
const ProjectCard = ({
  ...
  return (
    ...
    >
      <section className=" bg-gray-100 max-w-[42rem] overflow-hidden border-black/5 sm:pr-8 relative sm:h-[20rem] group-even:pl-8 hover:bg-gray-200 transition rounded-lg">
