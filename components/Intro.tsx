  ...
  return (
    <section className="mb-28 max-w-[50rem] text-center sm:mb-0">
      ...
      >
        ...
        <a className="group px-7 py-3 bg-white flex items-center gap-2 rounded-full outline-none focus:scale-110 hover:scale-110 active:scale-105 transition cursor-pointer">
          Downlaod CV{" "}
          <HiDownload className="group-hover:translate-y-1 transition" />
        </a>
        <a
          href=""
          className="px-7 py-3 bg-white flex items-center gap-2 rounded-full text-gray-700 cursor-pointer"
        >
          <BsLinkedin />
        </a>
        <a
          href=""
          className="px-7 py-3 bg-white flex items-center gap-2 rounded-full text-gray-700 text-[1.35rem] cursor-pointer"
        >
          <FaGithubSquare />
        </a>
      </motion.div>
